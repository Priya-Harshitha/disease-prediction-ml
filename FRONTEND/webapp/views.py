...
BASE_DIR = settings.BASE_DIR  # string path to FRONTEND
...
def helper(dis):
    ...
    pre = pre_row[['Precaution_1','Precaution_2','Precaution_3','Precaution_4']].values.tolist()[0] if not pre_row.empty else []
...
def get_predicted_value(symptoms):
    input_vector = process_input(symptoms)
